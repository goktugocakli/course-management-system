...
import {Label, AlertText, Text, Icon , AddButton, StartButton, Div, LabelDiv, InputRow, InputColumn, DateRow, Input, InputLabel, Line, List, ListItem} from "./styles/addSemester"
...
AddSemester.AlertText = function semestersAlertText({ children, ...restPorps }) {
